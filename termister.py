        ...
        try:
            with open(self.config_file) as file:
                ...
                if platform.system() == "Windows":
                    self.config_dir = os.path.dirname(self.config_file) + "\\" + data['configDirectory'] + "\\"
                else:
                    self.config_dir = os.path.dirname(self.config_file) + "/" + data['configDirectory'] + "/"
            ...
            with open(file, 'r') as file:
                ...
                for group in data['groups']:
                    ...
                    for host in group[group_name]['hosts']:
                        ...
                        thost = THost(host=host['host'], port=host['port'],
                                      user=host['user'],
...
if __name__ == "__main__":
    ...
    if args.command[0] != 'list' and args.command[0] != 'host':
        print("Incorrect command: " + args.command[0] + '\tUse "list" or "host HOSTNAME" command',
              file=sys.stderr)
        sys.exit(1)
